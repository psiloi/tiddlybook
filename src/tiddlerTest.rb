...
class TestTiddler < Test::Unit::TestCase
  ...
  def test_mediawiki_to_docbook
    tiddler = Tiddler.new('test on simple quotes', [], 'blahblah')
    ...
    trans = "<section xml:id=\"test_on_simple_quotes\">\n<title>test on simple quotes</title>\n<para>\n" <<
      "<emphasis>A'</emphasis>s front edge is always first\n\n</para>"
    trans2 = "</section>\n"
    beginning, ending = tiddler.mediawiki_to_docbook(contents)
